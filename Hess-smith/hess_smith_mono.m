...
[x1,y1]=importvector("./naca_7512_vector"); %import da xfoil profilo naca
U=1;
...
figure(2)
plot(centro(1,1:(N)/2-4),-Cp(1:(N)/2-4),'LineWidth', 3,'Color','r')
hold on
plot(centro(1,(N)/2-4:end),-Cp((N)/2-4:end),'LineWidth', 3,'Color','b')
legend(' Ventre ',' Dorso ')
grid on
grid minor
xlabel('x')
